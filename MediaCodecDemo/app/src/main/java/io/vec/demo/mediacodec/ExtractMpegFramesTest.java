...
public class ExtractMpegFramesTest extends AndroidTestCase {
    ...
    private static final String INPUT_FILE = "videoplayback.mp4";
    ...
    public static class CodecOutputSurface
        ...
        /*
        @author Yukun Zeng
        @constructor CodecOutputSurface(width, height, surface)
         */
        ...
        /*
        @author Yukun Zeng
        @method setup(surface)
        @description try to associate a specified surface object with the extractor
         */
        private void setup(Surface surface) {
            mTextureRender = new ExtractMpegFramesTest.STextureRender();
            mTextureRender.surfaceCreated();

            if (VERBOSE) Log.d(TAG, "textureID=" + mTextureRender.getTextureId());
            Method getSurfaceTexture = null;
            try {
                getSurfaceTexture = Surface.class.getDeclaredMethod("getSurfaceTexture");
                getSurfaceTexture.setAccessible(true);
